...
A simple personal dashboard for tracking migraine patterns from a Google Calendar.
...
3. Paste your Google Calendar link (the Secret Adress in ical Format, from Calendar Settings)
